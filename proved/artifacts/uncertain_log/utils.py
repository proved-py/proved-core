        ...
        if random.random() < p:
            ...
            if u_timestamp_key in uncertain_event and uncertain_event[u_timestamp_key]['value'] == u_continuous_strong:
                ...
                if module_name == 'scipy.stats':
                    event[timestamp_key] = getattr(importlib.import_module(module_name), '.'.join([class_name, 'rvs']))(**dict(uncertain_event[u_timestamp_key]['children'][u_function_key]['children']))
